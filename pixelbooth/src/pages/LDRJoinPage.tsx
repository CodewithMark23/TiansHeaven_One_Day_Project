  ...
  return (
    <div className="bg-snappy min-h-dvh flex items-center justify-center p-4">
      ...
      >
        ...
        <h1 className="font-display text-3xl mb-2" style={{ color: '#7c5cbf' }}>Join a Booth</h1>
        <p className="text-gray-400 text-sm mb-6">Enter the 6-digit code from your partner! 💌</p>
        ...
        <div className="flex flex-col gap-4 mb-6">
          ...
          <input
            ...
            className="cute-input text-center font-bold tracking-[0.4em] text-lg"
            value={code}
        ...
        {error && (
          <motion.div
            ...
            className="badge badge-pink mb-4 w-full justify-center py-1.5"
          >
            😕 {error}
          </motion.div>
        )}
