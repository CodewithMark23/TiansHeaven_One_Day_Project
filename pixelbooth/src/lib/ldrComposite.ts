/**
 * Compresses an image to JPEG (~30KB) so it can easily travel over Supabase Realtime broadcast (limit 256KB).
 */
export function compressForRealtime(dataUrl: string, maxDim = 480, quality = 0.72): Promise<string> {
